...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 960px) {
      ...
      .nav-links.menu-open a:hover { background: var(--almond-light); }

      /* Center/Right positions — use same mobile behavior */
      .nav-links-mobile.menu-open {
        ...
        border-top: 1px solid var(--almond); z-index: 899;
      }
    ...
    @media (max-width: 600px) {
      ...
      .nav-links.menu-open { top: 60px; }
      .nav-links-mobile.menu-open { top: 60px; }
