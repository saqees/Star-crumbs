...
<div class="page-enter cajitas-page">
  ...
  <div *ngIf="showPay()" class="sc-overlay" (click)="closeOnOverlay($event,'sc-overlay')">
    <div class="pay-modal">
      ...
      <!-- Tarjeta -->
      <div *ngIf="payMethod()==='tarjeta'" class="pay-detail">
        <div class="crd-card">
          <div class="crd-shine"></div>
          <div class="crd-chip"><div class="crd-cl"></div><div class="crd-cl"></div><div class="crd-cl"></div></div>
          <div class="crd-num">4771 7007 6016 6680</div>
          <div class="crd-bot">
            <div><span class="crd-lbl">VENCE</span><span class="crd-val">12/28</span></div>
            <div><span class="crd-lbl">CVV</span><span class="crd-val">884</span></div>
          </div>
        </div>
        <p class="crd-hint">Usa estos datos en tu app bancaria para la transferencia</p>
        <div class="pay-links">
          <a href="https://bancolombia.com.co" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-university"></i> App bancaria</a>
          <button class="btn btn-secondary btn-sm" (click)="copy('4771700760166680','Número de tarjeta')"><i class="fas fa-copy"></i> Copiar</button>
        </div>
      </div>
