...
type Tab = 'products'|'categories'|'orders'|'users'|'chat'|'carousel'|'cajitas'|'why_us'|'navbar'|'footer'|'pages'|'site_reviews'|'product_reviews'|'store_theme'|'page_banners'|'social_favicon';
...
export class AdminComponent implements OnInit {
  ...
  savePageBanner(page: string) {
    const data = page === 'products' ? this.pageBannerProducts : this.pageBannerCajitas;
