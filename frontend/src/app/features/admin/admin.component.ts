...
type Tab = 'products'|'categories'|'orders'|'users'|'chat'|'carousel'|'cajitas'|'why_us'|'navbar'|'footer'|'pages'|'site_reviews'|'product_reviews'|'store_theme'|'page_banners'|'page_banners_extra'|'social_favicon'|'push_notifications';
